...
def dispara(fila, columna, tablero_enemigo):
...
if __name__ == "__main__":
    ...
    while (True):
        ...
        if turno == 1:
            resultado_del_disparo = dispara(fila, columna, jugador2_Tablero)

        if turno == 2:
            resultado_del_disparo = dispara(fila, columna, jugador1_Tablero)
